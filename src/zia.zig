...
const build_options = @import("root").build_options;
...
// search path: root.build_options, root.server, default to false
pub const is_server: bool = build_options.is_server;

// search path: root.build_options, root.enable_imgui, default to false
pub const enable_imgui: bool = build_options.enable_imgui;
