...
pub fn SDL_FOURCC(A: anytype, B: anytype, C: anytype, D: anytype) callconv(.Inline) @TypeOf((((SDL_static_cast(Uint32, SDL_static_cast(Uint8, A)) << 0) | (SDL_static_cast(Uint32, SDL_static_cast(Uint8, B)) << 8)) | (SDL_static_cast(Uint32, SDL_static_cast(Uint8, C)) << 16)) | (SDL_static_cast(Uint32, SDL_static_cast(Uint8, D)) << 24)) {
...
pub fn SDL_iconv_utf8_ucs2(S: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast([*c]Uint16, SDL_iconv_string("UCS-2-INTERNAL", "UTF-8", S, SDL_strlen(S) + 1)))) {
    return (@import("std").meta.cast([*c]Uint16, SDL_iconv_string("UCS-2-INTERNAL", "UTF-8", S, SDL_strlen(S) + 1)));
}
pub fn SDL_iconv_utf8_ucs4(S: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast([*c]Uint32, SDL_iconv_string("UCS-4-INTERNAL", "UTF-8", S, SDL_strlen(S) + 1)))) {
...
pub fn SDL_InvalidParamError(param: anytype) callconv(.Inline) @TypeOf(SDL_SetError("Parameter '%s' is invalid", param)) {
...
pub fn SDL_SwapLE16(X: anytype) callconv(.Inline) @TypeOf(X) {
    return X;
}
pub fn SDL_SwapLE32(X: anytype) callconv(.Inline) @TypeOf(X) {
    return X;
}
pub fn SDL_SwapLE64(X: anytype) callconv(.Inline) @TypeOf(X) {
    return X;
}
pub fn SDL_SwapFloatLE(X: anytype) callconv(.Inline) @TypeOf(X) {
    return X;
}
pub fn SDL_SwapBE16(X: anytype) callconv(.Inline) @TypeOf(SDL_Swap16(X)) {
    return SDL_Swap16(X);
}
pub fn SDL_SwapBE32(X: anytype) callconv(.Inline) @TypeOf(SDL_Swap32(X)) {
    return SDL_Swap32(X);
}
pub fn SDL_SwapBE64(X: anytype) callconv(.Inline) @TypeOf(SDL_Swap64(X)) {
    return SDL_Swap64(X);
}
pub fn SDL_SwapFloatBE(X: anytype) callconv(.Inline) @TypeOf(SDL_SwapFloat(X)) {
...
pub fn SDL_TICKS_PASSED(A: anytype, B: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(Sint32, B - A)) <= 0) {
