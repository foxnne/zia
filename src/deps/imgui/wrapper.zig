...
extern fn _ogImDrawList_AddCircle (draw_list: [*c]imgui.ImDrawList, center: *imgui.ImVec2, radius: f32, col: imgui.ImU32, num_segments: i32, thickness: f32) void;
...
pub fn ogImDrawList_AddCircle (draw_list: [*c]imgui.ImDrawList, center: *imgui.ImVec2, radius: f32, col: imgui.ImU32, num_segments: i32, thickness: f32) void {
